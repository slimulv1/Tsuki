...
/* bg opacity (kitty background_opacity 0.92) */
float alpha = 0.92;

/* Terminal colors (16 first used in escape sequence) */
static const char *colorname[] = {
	/* 8 normal colors — Tokyo Night (kitty tokyo-night.conf) */
	"#15161e", /* black   */
	"#f7768e", /* red     */
	"#9ece6a", /* green   */
	"#e0af68", /* yellow  */
	...
	"#c0caf5", /* default foreground colour (Tokyo Night fg) */
	"#1a1b26", /* default background colour (Tokyo Night bg) */
};
...
unsigned int defaultcs = 5; /* cursor #bb9af7 (magenta) = kitty cursor */
